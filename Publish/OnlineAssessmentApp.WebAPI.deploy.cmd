...
@rem set MSDeployPath="E:\Program Files\IIS\Microsoft Web Deploy V3\"
@rem ---------------------------------------------------------------------------------
...
set _DeploySetParametersFile=%RootPath%OnlineAssessmentApp.WebAPI.SetParameters.xml
)
...
@rem ---------------------------------------------------------------------------------
if not exist "%RootPath%OnlineAssessmentApp.WebAPI.zip" (
echo "%RootPath%OnlineAssessmentApp.WebAPI.zip" does not exist. 
...
set _MSDeployCommandline="%MSDeployPath%msdeploy.exe" -source:package='%RootPath%OnlineAssessmentApp.WebAPI.zip' -dest:%_Destination% -verb:sync -disableLink:AppPoolExtension -disableLink:ContentExtension -disableLink:CertificateExtension
) else (
set _MSDeployCommandline="%MSDeployPath%msdeploy.exe" -source:package='%RootPath%OnlineAssessmentApp.WebAPI.zip' -dest:%_Destination% -verb:sync -disableLink:AppPoolExtension -disableLink:ContentExtension -disableLink:CertificateExtension -setParamFile:"%_DeploySetParametersFile%"
)
...
:usage
echo =========================================================
if not exist "%RootPath%OnlineAssessmentApp.WebAPI.deploy-readme.txt" (
...
start notepad "%RootPath%OnlineAssessmentApp.WebAPI.deploy-readme.txt"
)
echo =========================================================
goto :eof
